...
-- Records of course
-- ----------------------------
INSERT INTO `course` VALUES (1, '马克思主义基本原理概论', '马克思主义基本原理概论》是高校公共基础政治理论课，是实施高校思想政治理论课新方案后、在大学本科中进行马克思主义基本理论教育的课程。本课程综合了马克思主义三个组成部分即马克思主义哲学、政治经济学和科学社会主义的基本内容，对于培养大学生的人文素质，提高他们理论分析的素养和能力具有重要作用。', '通识选修课', 3.24, '马克思学院', '熊大', '本课程主要对学生进行唯物主义哲学的基本原理教育，使学生掌握马克思主义哲学的基本观点、立场和方法；帮助学生掌握马克思主义的世界观和方法论，帮助学生树立正确的人生观和价值观；培养学生运用马克思主义哲学的观点和方法去分析问题、解决问题的能力，提高学生的政治理论素质和思维水平；为学生正确理解马克思主义，确立社会主义信念自觉坚持党的路线、方针和政策打下坚实的基础。', '教学队伍6人全部具有博士学位。具有高级职称者4人， 40岁至60岁1人，30岁至40岁4人，20岁至30岁1人。年龄结构合理，发展平稳且可持续性好，具有很强的战斗力，形成了骨干教师承担教学重任，青年教师在梯队中培养锻炼的格局。', '《马克思主义基本原理概论》');
INSERT INTO `course` VALUES (2, '中国近现代史纲要', '《中国近现代史纲要》这门课程主要介绍了近现代时期中国人民反对外国侵略斗争，探索国家出路，改革浪潮中的大事变，中国革命的新道路，中华民族的抗体战争，改革开放与现代化建设新时期等内容。\r\n《中国近现代史纲要》这门课程主要介绍了近现代时期中国人民反对外国侵略斗争，探索国家出路，改革浪潮中的大事变，中国革命的新道路，中华民族的抗体战争，改革开放与现代化建设新时期等内容。', '必修课', 4.00, '历史学院', '熊大', '略', '略', '略');
INSERT INTO `course` VALUES (3, '操作系统', '《操作系统》是计算机应用技术专业开设的专业基础课，是培养学生具备计算机操作系统的基本理论、基本原理和应用能力的一门必修课，是学习其它后续专业课程的基础。本课程主要培养学生理解计算机操作系统的基本理论及原理，提高学生分析和解决软件系统问题的能力，是一门对学生操作系统相关知识的学习及应用能力培养起到关键、基础作用的课程。', '通识选修课', 5.00, '计算机与信息科学学院', '李白', '略', '略', '略');
INSERT INTO `course` VALUES (44, '音乐', '学好音乐课', '通识选修课', 2.00, '音乐学院', '林俊杰', '我是歌手', '每一个人都能唱歌', '音乐三百');
