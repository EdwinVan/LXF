<template>
  <el-container>
    <el-header class="indexTop" id="top" style="height: 100px">
        <el-row>
          <el-col :span="10">
            <h3 id="top-left">
              <el-image
      ...
      <div id="box1">
        <div class="first-box" id="Course-content">
          <div class="IndexBoxHeader">
            <div class="IndexBoxHeaderLeft">
              <i class="el-icon-document-copy"></i>
              <div class="h4">课程简介</div>
            </div>
          </div>
          <div class="IndexContent">
            <div class="IndexContentImage">
              <el-image
                  style="width: 200px; height: 250px"
                  :src="require('../../assets/book/1.jpg')"
                  :fit="fit"></el-image>
            </div>
            <div class="IndexContentP">
              <p>{{courses[0].introduction}}</p>
            </div>
          </div>
        </div>

        <div class="first-box" id="Course-target">
          <div class="IndexBoxHeader">
            <div class="IndexBoxHeaderLeft">
              <i class="el-icon-data-line"></i>
              <div class="h4">教学目标</div>
            </div>
          </div>
          <div class="IndexContent">
              <p>{{courses[0].goal}}</p>
